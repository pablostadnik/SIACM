...
<body style= "background-color: #386745;">
		...
		<div class="container contenido">
			...
			<form name="form-inline" class="form-horizontal" method="post" action="buscar_parcela.php">
				...
				<div class="control-group">
					<div class="controls">	
						...
						<button type="submit" class="btn btn-default" style= "height: 45px; width: 78px;position: relative;left: 350px;bottom: 62px;" name="buscar" >BUSCAR</button>
					</div>
				</div>
			</form>
		</div>
		...
		{	
			...
			$parc=$par->buscar_parcela($_POST["codigo"]);
				 }
		?>
		<div class="container contenido">
		<?php if (!empty($parc)){ ?>
