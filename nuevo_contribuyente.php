...
if(isset($_POST["cargar"]) )
{
	...
	$par->add_contribuyente($_POST['oculto'],$_POST["nombre"], $_POST["calle"], $_POST["barrio"], $_POST["numero"], $_POST["piso"], $_POST["departamento"], $_POST["cod_postal"], $_POST["documento"],$_POST["cod_titular"],$_POST["correo"],$_POST["fax"],$_POST['cuit'] );
}
?>
<html>
<head>
...
<body style= "background-color: #386745;">
		...
		<div class="container contenido">
			...
			<form name="form" class="form-horizontal" method="post" action="nuevo_contribuyente.php">
			<input type="hidden" name="oculto" value="<?php echo $cod;  ?>" />
				...
				<div class="control-group">
					<div class="controls">	
						...
						<input type="submit" class="btn btn-large btn-primary" value="Ingresar contribuyente" title="Ingresar contribuyente" name="cargar" />
					</div>
				</div>
			</form>
		</div>
